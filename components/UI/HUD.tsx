...
import { GameStatus, GALAXY_COLORS, ShopItem, RUN_SPEED_BASE } from '../../types';
  ...
  if (status === GameStatus.MENU) {
      return (
          <div className="absolute inset-0 flex items-center justify-center z-[100] bg-black/80 backdrop-blur-sm p-4 pointer-events-auto">
              {/* Menu Container */}
              <div className="relative w-full max-w-md rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,255,255,0.3)] border border-white/10 animate-in zoom-in-95 duration-500 bg-[#050011]">
                
                {/* Visual Content */}
                <div className="relative w-full pt-16 pb-12 px-8 flex flex-col items-center justify-center overflow-hidden">
                     {/* Background Glows */}
                     ...
                     <div className="relative z-10 mb-12 text-center">
                        <h1 className="text-6xl md:text-7xl font-black italic tracking-tighter text-white drop-shadow-[0_0_30px_rgba(0,255,255,1)] font-cyber leading-[0.8] flex flex-col">
                           <span>GALAXY</span>
                           <span className="text-cyan-400">RUNNER</span>
                        </h1>
                        <div className="mt-4 h-1 w-24 bg-gradient-to-r from-blue-500 via-cyan-400 to-purple-500 mx-auto rounded-full"></div>
                     </div>
                     ...
                     <div className="relative z-10 w-full">
                        <button 
                          ...
                          className="w-full group relative px-4 md:px-6 py-4 md:py-5 bg-white/10 backdrop-blur-md border border-white/20 text-white font-black text-lg md:text-2xl rounded-2xl hover:bg-white/20 transition-all shadow-[0_0_20px_rgba(0,255,255,0.3)] hover:shadow-[0_0_40px_rgba(0,255,255,0.6)] hover:border-cyan-400 overflow-hidden"
                        >
                            ...
                            <span className="relative z-10 tracking-[0.1em] md:tracking-[0.2em] flex items-center justify-center whitespace-nowrap">
                                INITIALIZE RUN <Play className="ml-2 md:ml-3 w-5 h-5 md:w-6 md:h-6 fill-white" />
                            </span>
                        </button>

                        <p className="text-cyan-400/60 text-xs font-mono mt-6 tracking-[0.3em] text-center uppercase">
          ...
          <div className="absolute inset-0 bg-black/90 z-[100] text-white pointer-events-auto backdrop-blur-sm overflow-y-auto">
              <div className="flex flex-col items-center justify-center min-h-full py-8 px-4">
                ...
                <div className="grid grid-cols-1 gap-3 md:gap-4 text-center mb-8 w-full max-w-md">
                    ...
                    <div className="bg-gray-900/80 p-3 md:p-4 rounded-lg border border-gray-700 flex items-center justify-between">
                        <div className="flex items-center text-cyan-400 text-sm md:text-base"><Trophy className="mr-2 w-4 h-4 md:w-5 md:h-5"/> TROPHIES COLLECTED</div>
